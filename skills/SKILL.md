...
*   Request confirmation before applying, patching, deleting, or scaling resources.
...
2.  Use `k8s_patch_resource` with `dry_run=true`.
3.  Explain the patch and expected impact.
4.  Ask for confirmation.
5.  Use `k8s_patch_resource` with `dry_run=false` only after approval.
